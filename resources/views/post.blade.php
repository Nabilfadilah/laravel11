        ...
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
            <article
                ...
                <header class="mb-4 lg:mb-6 not-format">
                    <a href="/posts" class="font-medium text-sm text-teal-600 hover:underline">&laquo; Back to all
                        posts</a>
                ...
                <section class="not-format">
                    <div class="flex justify-between items-center mb-6">
                        <p class="text-lg lg:text-2xl dark:text-white">{{ $post['body'] }}</p>
                    </div>
                </section>
            </article>
        </div>
...
{{-- <article class="py-8 px-5 max-w-screen-md shadow-2xl">
